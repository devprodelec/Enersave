<div class="half">  
  <div class="header">
	<h3><?php echo __("Agregar Horario") ?></h3>
  </div>
  <?php
	$inputDefaults = array('label'=>false, 'error'=>array('wrap'=>'span', 'class'=>'error')); 
	echo $this->Form->create('Schedule', array('action' => 'add/'.$process_id, 'inputDefaults' => $inputDefaults));
	echo $this->Form->hidden('process_id', array('value' => $process_id));
  ?>
  <table>
	<tr class="even">
